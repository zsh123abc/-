...
if __name__ == '__main__'
    data_dir = 'VOCdevkitVOC2007'
    train_file = 'VOCdevkitVOC2007ImageSetsMaintrain.txt'
    val_file = 'VOCdevkitVOC2007ImageSetsMainval.txt'
    test_file = 'VOCdevkitVOC2007ImageSetsMaintest.txt'
    voc2coco(data_dir, train_file, val_file, test_file)